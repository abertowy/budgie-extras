...
namespace  TestTime {
    ...
    public class TimeWindow : Gtk.Window {
        ...
        public TimeWindow (string uuid) {
            ...
            var image_01 = Gtk.Image.new_from_file("usr/share/pixmaps/03_cake_on.png");
            var image_02 = Gtk.Image.new_from_file("usr/share/pixmaps/03_cake.png");
            var image_03 = Gtk.Image.new_from_file("usr/share/pixmaps/03_cake.png");
            // position
